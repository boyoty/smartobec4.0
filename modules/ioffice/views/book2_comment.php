...
<div class="box box-success">
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="pull-left">
          <a href="<?php echo base_url().'index.php/ioffice/book2_comment'; ?>" class="btn btn-primary" title="เรียกข้อมูลใหม่"><i class="fa fa-refresh"></i> เรียกข้อมูลใหม่</a>
        </div>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url().'index.php/ioffice/book2_comment_form/'.$row->bookid.'/'.$row->commentid; ?>" class="btn btn-primary"><i class="fa fa-comment"></i> ลงความเห็น</a>
