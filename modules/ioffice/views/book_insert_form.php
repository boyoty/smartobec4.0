...
<div class="box box-success">
  ...
  <div class="box-body">
    <!-- ส่วนแสดงผล -->
      <form data-toggle="validator" role="form" enctype="multipart/form-data" class="form-horizontal" method="POST" action="<?php echo base_url(); ?>index.php/ioffice/book_insert">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" rows="5" name="bookdetail" id="bookdetail" placeholder="ส่วนสำหรับพิมพ์เนื้อหา"></textarea>
            <script>
        ...
        <div class='form-group'>
          ...
          <select  name='comment_personid' id='comment_personid' class="form-control select2" required>
                ...
                foreach ($book_person as $row_person) {
                  if($comment_personid->comment_personid==$row_person->person_id){ $selected='selected'; }else{ $selected=''; }
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            if($this->session->position_code<=11){ //ตำแหน่งที่อนุมัติเองได้ 
              ?> 
              <button type="submit" name="bookstatusid" value="20" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp;บันทึก | อนุมัติ</button>&nbsp;
            <?php } ?>
