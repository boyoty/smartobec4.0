...
<div class="box box-success">
  ...
  <div class="box-body">
    <!-- ส่วนแสดงผล -->
      <form data-toggle="validator" role="form" enctype="multipart/form-data" class="form-horizontal" method="POST" action="<?php echo base_url().'index.php/ioffice/book2_comment_save' ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <p>
            <label class="radio-inline">
              <input type="radio" name="bookstatusid" id="bookstatusid20" value="20" onclick="javascript:hideDiv('myContent');"><span class='glyphicon glyphicon-ok' aria-hidden='true'></span> รับ
            </label>
            <?php //if(($user_positionid!=1) and ($receive_booklevelid!=$row["receive_booklevelid"])){ ?>
            <label class="radio-inline">
              <input type="radio" name="bookstatusid" id="bookstatusid21" value="21" onclick="javascript:hideDiv('myContent');"><span class='glyphicon glyphicon-ok-circle' aria-hidden='true'></span> รับ | รอส่ง
            </label>
            </p>
            <p>
            <label class="radio-inline">
            ...
            <label class="radio-inline">
              <input type="radio" name="bookstatusid" id="bookstatusid40" value="40" onclick="javascript:hideDiv('myContent');"><span class='glyphicon glyphicon-remove' aria-hidden='true'></span> คืนเรื่อง
            </label>
            </p>
