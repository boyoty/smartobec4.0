  ...
  <div class="box-body">
    ...
    <?php echo form_open('school/answer_save'); ?>
      ...
      <table class="table table-condensed table-hover table-striped">
        ...
        <tfoot>
          <tr>
            <td colspan="2"><br><button class="btn btn-primary" type="submit" name="submit" value="save"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;บันทึกข้อมูล</button></td>
          </tr>
        </tfoot>
        <!-- รายการข้อมูล -->
        <tbody>
                ...
                <td>
                  ...
                  switch ($row->question_typeid) {
                    ...
                    case 2:
                      ...
                      break;
                    case 3:
                      echo '<input type="text" class="form-control" name="'.$row->question_id.'" placeholder="ตัวเลข">';
                      break;
                    case 4:
                      echo '<input type="text" class="form-control" name="'.$row->question_id.'" placeholder="ร้อยละ">';
                      break;
                    case 5:
                      echo '<input type="text" class="form-control" name="'.$row->question_id.'" placeholder="ข้อความสั้นๆ">';
                      break;
                    case 6:
                      ?>
                      <!-- radio -->
                      <div class="form-group">
                        ...
                        foreach ($answer_array as $value) {
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="<?php echo $row->question_id; ?>" value="<?php echo $value; ?>">
                              <?php echo $value; ?>
                            </label>
                          </div>
                          <?php
                    ...
                    case 7:
                      ...
                      break;
                    case 8:
                      echo '<textarea name="'.$row->question_id.'" class="form-control" rows="3"></textarea>';
                      break;
