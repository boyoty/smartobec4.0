...
<head>
  ...
  <!-- iCheck -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/iCheck/flat/blue.css">-->
  <!-- Morris chart -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/morris/morris.css">-->
  <!-- jvectormap -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/jvectormap/jquery-jvectormap-1.2.2.css">-->
  <!-- Date Picker -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/datepicker/datepicker3.css">-->
  <!-- Daterange picker -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/daterangepicker/daterangepicker-bs3.css">-->
  <!-- bootstrap wysihtml5 - text editor -->
  <!--<link rel="stylesheet" href="<?php //echo base_url(); ?>assets/adminlte233/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">-->
  <!-- iCheck -->
...
<!-- ./wrapper -->
  ...
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/morris/morris.min.js"></script>-->
  <!-- Sparkline -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/sparkline/jquery.sparkline.min.js"></script>-->
  <!-- jvectormap -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>-->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>-->
  <!-- jQuery Knob Chart -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/knob/jquery.knob.js"></script>-->
  <!-- daterangepicker -->
  <!--<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>-->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/daterangepicker/daterangepicker.js"></script>-->
  <!-- datepicker -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/datepicker/bootstrap-datepicker.js"></script>-->
  <!-- Bootstrap WYSIHTML5 -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>-->
  <!-- Slimscroll -->
  <script src="<?php echo base_url(); ?>assets/adminlte233/plugins/slimScroll/jquery.slimscroll.min.js"></script>
  <!-- FastClick -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/fastclick/fastclick.js"></script>-->
  <!-- AdminLTE App -->
  <script src="<?php echo base_url(); ?>assets/adminlte233/dist/js/app.min.js"></script>
  <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/dist/js/pages/dashboard.js"></script>-->
  <!-- AdminLTE for demo purposes -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/dist/js/demo.js"></script>-->
  <!-- iCheck -->
  <!--<script src="<?php //echo base_url(); ?>assets/adminlte233/plugins/iCheck/icheck.min.js"></script>-->
  <!--
  <script>
    $(function () {
      $('input').iCheck({
